...
{
	{
		...
		std::cout << "const lower bound: "<< (*cit).data << std::endl;
		...
		std::cout<<"lower bound of 2: "<<tree4.lower_bound(2)->data<<std::endl;
		std::cout<<"upper bound of 2: "<<tree4.upper_bound(2)->data<<std::endl;
		std::cout<<"cosnt upper bound of 2: "<<tree4_const.upper_bound(2)->data<<std::endl;
		...
		std::cout<<"equal range first of 2: " << (*p.first).data << std::endl;
		std::cout<<"equal range second of 2: " << (*p.second).data << std::endl;
		std::cout<<"const range first of 2: " << (*cp.first).data << std::endl;
		std::cout<<"const range second of 2: " << (*cp.second).data << std::endl;
