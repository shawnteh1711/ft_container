...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   copy_tree_iterator.hpp                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: steh <steh@student.42.fr>                  +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/17 20:05:24 by steh              #+#    #+#             */
/*   Updated: 2023/01/19 22:37:15 by steh             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef TREE_ITERATOR2_HPP
# define TREE_ITERATOR2_HPP
...
namespace ft
{
	template<class Key, class T> // because if neither Key or T is a node, u cannot typedef one of two as pointer...
	class tree_iterator
	{
		public:
			...
			typedef Node<Key, value_type>*							node_pointer;
			typedef Node<Key, value_type>*							pointer;
			typedef Node<Key, value_type>&							reference;
			...
			template <class It> 
			tree_iterator(const tree_iterator<It, typename ft::enable_if<std::is_same<It, node_pointer>::value, node_pointer>::type>& iter) : _current_node(iter._current_node)
			{
